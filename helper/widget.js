/* paw-helper embeddable widget for bingyan.me - CUSTOMIZED copy of the default.
 * Served from the pack root in place of the framework default. Changes vs default:
 * a larger launcher (shows "Ask about Bing Yan"), a wider 640px dialog, and bigger
 * input/result text in px (so the host page's root font size can't shrink it).
 *
...
(function () {
  ...
  var CSS = [
    ...
    '.paw-helper__launch svg{ width: 28px; height: 28px; flex: 0 0 auto; }',
    ...
    '.paw-helper__dialog{',
    '  position: fixed; z-index: 2147483001; top: 10vh; left: 50%;',
    '  transform: translateX(-50%); width: min(640px, calc(100vw - 2rem));',
    '  background: var(--paw-bg-elevated); color: var(--paw-fg);',
    '  border: 1px solid var(--paw-border); border-radius: 16px;',
    '  box-shadow: var(--paw-shadow-lg); overflow: hidden;',
    '  font-family: inherit; font-size: 16px;',
    '}',
    '.paw-helper__bar{ display: flex; align-items: center; gap: 10px; padding: 6px 18px; border-bottom: 1px solid var(--paw-border); margin: 0; }',
    '.paw-helper__search{ color: var(--paw-fg-muted); flex: 0 0 auto; width: 22px; height: 22px; }',
    '.paw-helper__input{',
    '  flex: 1 1 auto; border: none; background: transparent; color: var(--paw-fg);',
    '  font-family: inherit; font-size: 19px; padding: 18px 4px;',
    '}',
    ...
    '.paw-helper__results{ max-height: 62vh; overflow-y: auto; }',
    '.paw-helper__placeholder{ margin: 0; padding: 18px 20px; color: var(--paw-fg-muted); font-size: 15px; }',
    '.paw-helper__result{ display: block; padding: 18px 20px; border-bottom: 1px solid var(--paw-border); }',
    ...
    '.paw-helper__result-title{ display: block; font-weight: 600; font-size: 17px; color: var(--paw-brand); }',
    '.paw-helper__result-desc{ display: block; margin-top: 4px; font-size: 14px; color: var(--paw-fg-muted); }',
    '.paw-helper__answer-text{ margin: 0; font-size: 16px; line-height: 1.6; color: var(--paw-fg); }',
    ...
    '  .paw-helper__launch{ width: 64px; height: 64px; min-height: 0; padding: 0; border-radius: 50%; }',
    '  .paw-helper__launch-label{ display: none; }',
    '  .paw-helper__launch svg{ width: 30px; height: 30px; }',
