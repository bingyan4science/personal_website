...
(function () {
  ...
  var CSS = [
    ...
    '  font-family: inherit; font-size: 21px; padding: 22px 6px;',
    '}',
    ...
    '.paw-helper__placeholder{ margin: 0; padding: 20px 24px; color: var(--paw-fg-muted); font-size: 17px; }',
    '.paw-helper__result{ display: block; padding: 20px 24px; border-bottom: 1px solid var(--paw-border); }',
    ...
    '.paw-helper__result-title{ display: block; font-weight: 600; font-size: 19px; color: var(--paw-brand); }',
    '.paw-helper__result-desc{ display: block; margin-top: 5px; font-size: 15px; color: var(--paw-fg-muted); }',
    '.paw-helper__answer-text{ margin: 0; font-size: 18px; line-height: 1.6; color: var(--paw-fg); }',
